...
float intLumi = 1143;
TString massPoint = "130";
float massPointFloat = 130.;
...
TH1F *histoWithWeight(TString nom){
	...
	float weights[4] = {
		14.12*0.00226/109978, // Higgs GLuon fusion
		(0.5008+0.2778)*0.00226/106206, // Higgs strallung
		0.07658*0.00226/22000, // Higgs TT
		1.154*0.00226/109686 // Higgs VBF
    };  
	theHistoGG->Sumw2();
...
void performFits_130(){
	...
	RooRealVar wHiggs_cat0("wHiggs_cat0","#sigma_{0}",0.8,0.1,5, "GeV") ;
	...
	RooRealVar wHiggs2_cat0("wHiggs2_cat0","#sigma_{1}",0.8,0.1,5, "GeV") ;
