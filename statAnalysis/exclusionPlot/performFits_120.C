...
float intLumi = 1143;
TString massPoint = "120";
float massPointFloat = 120.;
...
TH1F *histoWithWeight(TString nom){
	...
	float weights[4] = {
		18.13*0.00225/105132, // Higgs GLuon fusion
		(0.8754+0.3598+0.09756)*0.00225/109964, // Higgs strallung
		0.09756*0.00225/22000, // Higgs TT
		1.269*0.00225/109692 // Higgs VBF
    };  
	theHistoGG->Sumw2();
...
void performFits_120(){
	...
	RooRealVar wHiggs_cat3("wHiggs_cat3","#sigma_{0}",1.,0.1,5, "GeV") ;
	...
	RooRealVar wHiggs2_cat3("wHiggs2_cat3","#sigma_{1}",1.,0.1,5, "GeV") ;
