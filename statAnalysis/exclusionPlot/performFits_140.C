...
float intLumi = 1143;
TString massPoint = "140";
float massPointFloat = 140.;
...
TH1F *histoWithWeight(TString nom){
	...
	float weights[4] = {
		12.13*0.00193/109977, // Higgs GLuon fusion
		(0.3857+0.2172)*0.00193/107213, // Higgs strallung
		0.06072*0.00193/22000, // Higgs TT
		1.052*0.00193/109665 // Higgs VBF
    };  
	theHistoGG->Sumw2();
