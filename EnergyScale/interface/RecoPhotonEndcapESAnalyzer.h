#ifndef Maravin_EgammaClusterProducers_RecoPhotonEndcapESAnalyzer_h
#define Maravin_EgammaClusterProducers_RecoPhotonEndcapESAnalyzer_h
/**\class RecoPhotonEndcapESAnalyzerx
...
*/
//
// $Id: RecoPhotonEndcapESAnalyzer.h,v 1.1.1.1 2009/07/10 14:09:15 hbrun Exp $
//
...
class RecoPhotonEndcapESAnalyzer : public edm::EDAnalyzer {
   public:
      explicit RecoPhotonEndcapESAnalyzer( const edm::ParameterSet& );
      ~RecoPhotonEndcapESAnalyzer();
