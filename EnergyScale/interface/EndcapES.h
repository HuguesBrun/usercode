#ifndef Maravin_EgammaClusterProducers_EndcapES_h
#define Maravin_EgammaClusterProducers_EndcapES_h
/**\class EndcapESx
...
*/
//
// $Id: EndcapES.h,v 1.1.1.1 2009/07/10 14:09:15 hbrun Exp $
//
...
class EndcapES : public edm::EDAnalyzer {
   public:
      explicit EndcapES( const edm::ParameterSet& );
      ~EndcapES();
