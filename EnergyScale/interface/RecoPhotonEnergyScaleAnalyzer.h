#ifndef Maravin_EgammaClusterProducers_RecoPhotonEnergyScaleAnalyzer_h
#define Maravin_EgammaClusterProducers_RecoPhotonEnergyScaleAnalyzer_h
/**\class RecoPhotonEnergyScaleAnalyzerx
...
*/
//
// $Id: RecoPhotonEnergyScaleAnalyzer.h,v 1.2 2009/07/31 12:26:19 hbrun Exp $
//
...
class RecoPhotonEnergyScaleAnalyzer : public edm::EDAnalyzer {
   public:
      explicit RecoPhotonEnergyScaleAnalyzer( const edm::ParameterSet& );
      ~RecoPhotonEnergyScaleAnalyzer();
