#ifndef Maravin_EgammaClusterProducers_PhotonEndcapESAnalyzer_h
#define Maravin_EgammaClusterProducers_PhotonEndcapESAnalyzer_h
/**\class PhotonEndcapESAnalyzerx
...
*/
//
// $Id: PhotonEndcapESAnalyzer.h,v 1.1.1.1 2009/07/10 14:09:15 hbrun Exp $
//
...
class PhotonEndcapESAnalyzer : public edm::EDAnalyzer {
   public:
      explicit PhotonEndcapESAnalyzer( const edm::ParameterSet& );
      ~PhotonEndcapESAnalyzer();
