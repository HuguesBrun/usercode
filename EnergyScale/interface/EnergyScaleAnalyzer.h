#ifndef Maravin_EgammaClusterProducers_EnergyScaleAnalyzer_h
#define Maravin_EgammaClusterProducers_EnergyScaleAnalyzer_h
...
*/
//
// $Id: EnergyScaleAnalyzer.h,v 1.1.1.1 2009/07/10 14:09:15 hbrun Exp $
//
