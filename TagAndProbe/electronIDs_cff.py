...
PASS_TRIGGER_CUT = ("(("
                    ...
                    +" deltaPhiSuperClusterTrackAtVtx > -0.15 && deltaPhiSuperClusterTrackAtVtx < 0.15 &&" 
                    +" deltaEtaSuperClusterTrackAtVtx > -0.007 && deltaEtaSuperClusterTrackAtVtx < 0.007 &&" 
                    +" hadronicOverEm < 0.12 )||"
                    +"(!isEB && sigmaIetaIeta < 0.03&&"
                    +" deltaPhiSuperClusterTrackAtVtx > -0.10 && deltaPhiSuperClusterTrackAtVtx < 0.10 &&" 
...
ELE_ID_TRIG = PASS_TRIGGER_CUT+"&&"+ELE_ID_EGAMMA_2012

ELE_ID_TRIG_ISO = ELE_ID_TRIG + "&&" + ELE_ISO_EGAMMA_2012

ELE_ISO_TRIG = PASS_TRIGGER_CUT+"&&"+ELE_ISO_EGAMMA_2012
...
VAR_OOEMOOP     = ("(1.0/ecalEnergy() - eSuperClusterOverP/ecalEnergy)")

ELE_POG_LOOSE_ID = ("(( isEB && sigmaIetaIeta < 0.01 &&" +           
                    " deltaPhiSuperClusterTrackAtVtx > -0.15 && deltaPhiSuperClusterTrackAtVtx < 0.15 &&" +
                    " deltaEtaSuperClusterTrackAtVtx > -0.007 && deltaEtaSuperClusterTrackAtVtx < 0.007 &&" +
                    " hadronicOverEm < 0.12 &" +
                    VAR_OOEMOOP + "< 0.05 && "+VAR_OOEMOOP+"> -0.05 && "+
                    "( abs(userFloat('tip')) < 0.02 && abs(userFloat('dzPV')) < 0.2) &&"+
                    "(userFloat('convValueMapProd:passVtxConvert') != 0 && gsfTrack.trackerExpectedHitsInner.numberOfHits <= 1) &&"+
                    " ((pt > 20 && "+ PF_ISO + "< 0.15)||(pt < 20 && "+ PF_ISO + " < 0.15)))||" +
                    "( (!isEB) && sigmaIetaIeta < 0.03 &&" +           
                    " deltaPhiSuperClusterTrackAtVtx > -0.1 && deltaPhiSuperClusterTrackAtVtx < 0.1 &&" +
                    " deltaEtaSuperClusterTrackAtVtx > -0.009 && deltaEtaSuperClusterTrackAtVtx < 0.009 &&" +
                    " hadronicOverEm < 0.1 &" +
                    VAR_OOEMOOP + "< 0.05 && "+VAR_OOEMOOP+"> -0.05 && "+
                    "( abs(userFloat('tip')) < 0.02 && abs(userFloat('dzPV')) < 0.2) &&"+
                    "(userFloat('convValueMapProd:passVtxConvert') != 0 && gsfTrack.trackerExpectedHitsInner.numberOfHits <= 1) &&"+
                    " ((pt > 20 && "+ PF_ISO + "< 0.15)||(pt < 20 && "+ PF_ISO + " < 0.1))))")


ELE_POG_TIGHT_ID = ("(( isEB && sigmaIetaIeta < 0.01 &&" +           
                    " deltaPhiSuperClusterTrackAtVtx > -0.03 && deltaPhiSuperClusterTrackAtVtx < 0.03 &&" +
                    " deltaEtaSuperClusterTrackAtVtx > -0.004 && deltaEtaSuperClusterTrackAtVtx < 0.004 &&" +
                    " hadronicOverEm < 0.12 &" +
                    VAR_OOEMOOP + "< 0.05 && "+VAR_OOEMOOP+"> -0.05 && "+
                    "( abs(userFloat('tip')) < 0.02 && abs(userFloat('dzPV')) < 0.1) &&"+
                    "(userFloat('convValueMapProd:passVtxConvert') != 0 && gsfTrack.trackerExpectedHitsInner.numberOfHits <= 0) &&"+
                    " ((pt > 20 && "+ PF_ISO + "< 0.10)||(pt < 20 && "+ PF_ISO + " < 0.10)))||" +
                    "( (!isEB) && sigmaIetaIeta < 0.03 &&" +           
                    " deltaPhiSuperClusterTrackAtVtx > -0.3 && deltaPhiSuperClusterTrackAtVtx < 0.3 &&" +
                    " deltaEtaSuperClusterTrackAtVtx > -0.005 && deltaEtaSuperClusterTrackAtVtx < 0.005 &&" +
                    " hadronicOverEm < 0.1 &" +
                    VAR_OOEMOOP + "< 0.05 && "+VAR_OOEMOOP+"> -0.05 && "+
                    "( abs(userFloat('tip')) < 0.02 && abs(userFloat('dzPV')) < 0.1) &&"+
                    "(userFloat('convValueMapProd:passVtxConvert') != 0 && gsfTrack.trackerExpectedHitsInner.numberOfHits <= 0) &&"+
                    " ((pt > 20 && "+ PF_ISO + "< 0.10)||(pt < 20 && "+ PF_ISO + " < 0.07))))")
