...
chain->Add("/sps/cms/hbrun/miniTree361pX/part2/output_*.root");

int cutOffSet = 0;
int nbCuts = 8;
TString cuts[8] = {"(abs(pho_eta)<=2.5)&&(!((abs(pho_eta)>1.4442)&&(abs(pho_eta)<1.566)))","pho_hoe<0.05","pho_et>30","pho_hasPixelSeed==0","pho_IsoHollowTrkCone<2","pho_IsoEcalRechit<4.2","pho_IsoHcalRechit<2.2","((pho_isEB==1&&pho_sigmaIetaIeta<0.01)||(pho_isEE==1&&pho_sigmaIetaIeta<0.03))"};
////////////////////   Modif pour les cut en pt hat

int nbCutsIso =6;
TString cutsIso[6] = {"(abs(pho_eta)<=2.5)&&(!((abs(pho_eta)>1.4442)&&(abs(pho_eta)<1.566)))","pho_hasPixelSeed==0","pho_et>30","pho_IsoHollowTrkCone<2&&pho_IsoEcalRechit<4.2&&pho_IsoHcalRechit<2.2","pho_hoe<0.05","((pho_isEB==1&&pho_sigmaIetaIeta<0.01)||(pho_isEE==1&&pho_sigmaIetaIeta<0.03))"};
...
AlltheCuts+="1";
	...
	doHistoGeneTroisCut("photon_eta","pho_eta",-3.1,3.1,32,AlltheCuts,0,myFile);
	...
	doHistoGeneTroisCut("transMomtoJetNorm","pho_transverseToJetRatio",-0.1,1,101,AlltheCuts,1,myFile);
	doHistoGeneTroisCut("transMomtoJetNorm","pho_transverseToJetRatio",-0.1,1,101,AlltheCuts,2,myFile);

	doHistoGeneTroisCut("transMomtoJetNorm_pt2","pho_transverseToJetRatio_pt2",-0.1,1,101,AlltheCuts,1,myFile);
	doHistoGeneTroisCut("transMomtoJetNorm_pt2","pho_transverseToJetRatio_pt2",-0.1,1,101,AlltheCuts,2,myFile);

	doHistoGeneTroisCut("transMomtoJetNorm_pt5","pho_transverseToJetRatio_pt5",-0.1,1,101,AlltheCuts,1,myFile);
	doHistoGeneTroisCut("transMomtoJetNorm_pt5","pho_transverseToJetRatio_pt5",-0.1,1,101,AlltheCuts,2,myFile);

	doHistoGeneTroisCut("transMomtoJetNorm_pt10","pho_transverseToJetRatio_pt10",-0.1,1,101,AlltheCuts,1,myFile);
	doHistoGeneTroisCut("transMomtoJetNorm_pt10","pho_transverseToJetRatio_pt10",-0.1,1,101,AlltheCuts,2,myFile);

	doHistoGeneTroisCut("transMomtoJetNorm_pt20","pho_transverseToJetRatio_pt20",-0.1,1,101,AlltheCuts,1,myFile);
	doHistoGeneTroisCut("transMomtoJetNorm_pt20","pho_transverseToJetRatio_pt20",-0.1,1,101,AlltheCuts,2,myFile);
